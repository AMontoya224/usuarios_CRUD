...
class Usuario:
    ...
    def agregaUsuario( cls, nuevoUsuario ):
        ...
        resultado2 = connectToMySQL( "mydb" ).query_db( query2 )
        return resultado
    ...
    def eliminarUsuario( self, usuario ):
        ...
        resultado = connectToMySQL( "mydb" ).query_db( query, usuario )
        return resultado
    ...
    def editarUsuario( self, usuarioAEditar ):
        ...
        resultado = connectToMySQL( "mydb" ).query_db( query, usuarioAEditar )
        return resultado